...
/// GET /logo.png — Serve the OpenParlant logo.
...
/// GET /favicon.ico — Serve the OpenParlant favicon.
...
/// GET / — Serve the OpenParlant Dashboard single-page application.
///
...
/// The embedded HTML/CSS/JS for the OpenParlant Dashboard.
///
...
const WEBCHAT_HTML: &str = concat!(
    ...
    "\n",
    include_str!("../static/js/pages/control-journey-builder.js"),
    "\n",
    ...
    "\n",
    include_str!("../static/js/pages/control.js"),
    "\n</script>\n",
