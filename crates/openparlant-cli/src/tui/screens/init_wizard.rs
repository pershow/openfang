...
//!
//! Launched by `openparlant init` (without `--quick`). Takes over the terminal,
...
/// Check if the `openparlant-desktop` binary exists next to the current exe.
