...
1. 在 `openparlant-memory`、`openparlant-control`、`openparlant-policy`、`openparlant-journey`、`openparlant-context` 前先收口 repository / store trait，避免 `rusqlite::Connection` 继续向上泄漏
